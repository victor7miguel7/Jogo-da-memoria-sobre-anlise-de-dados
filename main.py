...
fonte = pygame.font.SysFont(None, 30)  # Fonte padrão do Pygame com tamanho 30
...
def desenha_texto(janela, texto, pos):
    """Função para desenhar texto na janela do Pygame."""
    superficie_texto = fonte.render(texto, True, (255, 255, 255))  # Renderiza o texto em branco
    janela.blit(superficie_texto, pos)
